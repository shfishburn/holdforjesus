    ...
    <div className="max-w-2xl mx-auto px-6 py-12">
      ...
      >
        ...
        <div className="space-y-4 text-sm text-foreground leading-relaxed">
          ...
          <p>
            <strong>Anonymous by default.</strong> You do not need an account to use the site. We do
            not ask for your name, email, or phone number.
          </p>
          <p>
          ...
          <p>
            ...
            generation and are not persisted as prayer-history records on our backend. If you choose
            to post to the Prayer Wall, that submitted wall text is stored server-side.
          </p>
          ...
          <p>
            ...
            No tracking cookies. No ad-tech trackers. No divine surveillance.
          </p>
          ...
          <p>
            ...
            "Clear all" button in your call history. For server-side data questions, use the contact
            channel below and include relevant timestamps/details so we can locate records.
          </p>

          <h2 className="font-bold text-lg text-foreground mt-6">Contact</h2>
          <p>
            For privacy inquiries, please dial 1-800-JESUS and select the Privacy Department. (Just
            kidding. This is a comedy app.)
          </p>
        </div>
      </motion.div>
    </div>
